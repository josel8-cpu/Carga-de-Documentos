...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COMPLEMENTARIOS = [
    'Aclaración firmas por inconsistencias', 'Autorización entrega de vehículo y resguardo de llave',
    'Acta de supervisión', 'Reporte fotográfico', 'Carta aceptación de endoso (cuando aplique)', 'Carta consentimiento',
    'Endoso jurídico (cuando aplique)', 'Formato de sustitución garantia', 'Otros'
  ];
  const DOCUMENTOS_ACREDITADO = [
    ...
    'Fotos del Domicilio (inhabilitar / mandar a llamar)', 'Fotos de la Actividad (inhabilitar / mandar a llamar)', 'Comprobante de Ingresos (inhabilitar / mandar a llamar)',
    'Autorización de Consulta de Buró', 'Carta de Excepción a la Norma (inhabilitar / mandar a llamar)',
  ];
  const DOCUMENTOS_AVAL = [
    'Identificacion Oficial Aval (inhabilitar / mandar a llamar)', 'CURP Aval (inhabilitar / mandar a llamar)', 'RFC Aval (inhabilitar / mandar a llamar)', 'Acta nacimiento aval (inhabilitar / mandar a llamar)',
  ...
  const DOCUMENTOS_GARANTIA = [
    ...
    'Garantía Adicional 1', 'Garantía Adicional 2', 'Pagaré de Distribuidor (cuando aplique)',
    'Cotización del Seguro (mandar a llamar de carga de documentos)', 'Póliza del Seguro', 'Comprobante de Pago del Seguro',
    'Evidencia de instalación del GPS', 'Estado de Cuenta (inhabilitar)', 'Enganche (inhabilitar)',
    'Garantia Liquida (inhabilitar)', 'Comisión por Apertura (inhabilitar)', 'Co Financiamiento (inhabilitar)',
    'Complemento de Enganche (inhabilitar)', 'Garantia Liquida Enganche Diferido (inhabilitar)', 'Enganche GPS (inhabilitar)', 'Otros'
  ];
